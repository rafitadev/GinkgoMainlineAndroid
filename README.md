...
| P8 | Android 17 GSI boot | Kernel config + boot.img tooling done, on-device pending |

**Flash a Release image:** [English](docs/flash-guide.md) · [中文](docs/zh-CN/flash-guide.md)

**Boot Android 17 GSI with the mainline kernel:** [English](docs/ginkgo-android-gsi.md) · [中文](docs/zh-CN/ginkgo-android-gsi.md)
...
| Android 17 GSI | [guide](docs/ginkgo-android-gsi.md) | [指南](docs/zh-CN/ginkgo-android-gsi.md) |
